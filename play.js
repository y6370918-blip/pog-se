...
const marker_info = {
    ...
    _11th_army: {name: "11th Army", counter: "marker _11th_army", size: 45, cardIndex: 94},
    ...
    guns_of_august: {name: "Guns of August", counter: "cp-marker marker guns_of_august", size: 45, cardIndex: 66},
    entrench_cp: {name: "Entrench", counter: "cp-marker marker entrench", size: 45, cardIndex: 71},
    race_to_the_sea: {name: "Race to the Sea", counter: "cp-marker marker race_to_the_sea", size: 45, cardIndex: 73},
    oberost: {name: "Oberost", counter: "cp-marker marker oberost", size: 45, cardIndex: 76},
    reichstag_truce: {name: "Reichstag Truce", counter: "cp-marker marker reichstag_truce", size: 45, cardIndex: 74},
    falkenhayn: {name: "Falkenhayn", counter: "cp-marker marker falkenhayn", size: 45, cardIndex: 78},
    high_seas_fleet: {name: "High Seas Fleet", counter: "cp-marker marker high_seas_fleet", size: 45, cardIndex: 90},
    zeppelin_raids: {name: "Zeppelin Raids", counter: "cp-marker marker zeppelin_raids", size: 45, cardIndex: 92},
    hoffmann: {name: "Hoffmann", counter: "cp-marker marker hoffmann", size: 45, cardIndex: 102},
    michael: {name: "Michael", counter: "cp-marker marker michael", size: 45, cardIndex: 114},
    blucher: {name: "Blucher", counter: "cp-marker marker blucher", size: 45, cardIndex: 115},
    peace_offensive: {name: "Peace Offensive", counter: "cp-marker marker peace_offensive", size: 45, cardIndex: 116},
    h_l_take_command: {name: "H-L Take Command", counter: "cp-marker marker h_l_take_command", size: 45, cardIndex: 119},
    polish_restoration: {name: "Polish Restoration", counter: "cp-marker marker polish_restoration", size: 45, cardIndex: 124},
}

...
const marker_info = {
    ...
    race_to_the_sea: {name: "Race to the Sea", counter: "cardtip cp-card marker race_to_the_sea ", size: 45, cardIndex: 73},
    ...
    moltke: {name: "Moltke", counter: "cardtip ap-card marker moltke ", size: 45, cardIndex: 9},
